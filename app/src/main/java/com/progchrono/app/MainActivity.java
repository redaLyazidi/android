...
public class MainActivity extends AbstractActivity implements View.OnClickListener, Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timesTextView = findTextViewById(R.id.numberUnit);
   ...
   /*Intent intent = new Intent(getBaseContext(), SignoutActivity.class);
    ...
    private void setProgramToChronometer() {
        final String numberUnit = numberUnitTextView.getText().toString();
        final String unitSymbol = unitSymbolspinner.getSelectedItem().toString();
        final String times = timesTextView.getText().toString();
        if (!(isReallyNullOrEmpty(numberUnit) && isReallyNullOrEmpty(unitSymbol) && isReallyNullOrEmpty(times))) {
            ChronometerProgram chronometerProgram = chronometer.getChronometerProgram();
            chronometerProgram.setNumberUnit(numberUnit);
            chronometerProgram.setUnitSymbol(unitSymbol);
            chronometerProgram.setTimes(times);
        }
    }
